...
//                }
                    if (s.array.get(i).variables[j].doubleVariable>p.upper){
                        s.array.get(i).variables[j].doubleVariable=p.upper-0.01;
                }else if (s.array.get(i).variables[j].doubleVariable<p.lower){
                        s.array.get(i).variables[j].doubleVariable=p.lower+0.01;
                }
